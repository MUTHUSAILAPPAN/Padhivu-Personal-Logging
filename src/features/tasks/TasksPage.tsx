      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
            <CheckSquare className="w-8 h-8 text-brand-emerald" />
            Tasks
          </h1>
          <p className="text-brand-text-muted mt-1">Organize your daily targets and status priorities.</p>
        </div>
        <button
          disabled
      ...
      <div className="bg-brand-bg-card border border-brand-border rounded-2xl p-8 text-center space-y-4 max-w-xl mx-auto mt-12 shadow-subtle">
        ...
        <div className="space-y-2">
          ...
          <p className="text-brand-text-muted text-sm leading-relaxed">
            Please import an existing workbook or download a starter one on the home page to begin tracking tasks.
          </p>
        </div>
      </div>
    </div>
